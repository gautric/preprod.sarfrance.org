...
- [x] 28. Pied de page > Secrétariat : mise en surbrillance permanente de l'adresse e-mail — ajout d'un style CSS `.footer-col p a` (couleur dorée, souligné) pour que le lien soit visible sans avoir à cliquer ou survoler
- [x] 28. Organisation > Objet et Histoire : migration de la section « Fondation et débuts » depuis la page d'accueil Organisation (_index.md) vers la page Objet et Histoire (FR/EN) — la page _index.md ne conserve plus que l'introduction et l'objet de la Société
- [x] 29. Activités > Bibliothèque : enrichissement des fiches ouvrages dans data/bibliotheque.yaml — correction des noms d'auteurs abrégés ou erronés (DELITTE Jean-Yves, RODE Iris de, KUNSTLER Charles, MÉNARD Pierre, SCHULTE NORDHOLT Jan Willem, BODINIER Gilbert, CHEVALIER Louis Édouard, LE MAIRE Jean-François, MAHAN Alfred Thayer, LACOUR-GAYET, MARZAGALLI), ajout d'ISBN (9782344020920, 9782745356840, 9791037608741, 9782749148304, 9782600018074) et d'images de couverture pour les entrées incomplètes, mise à jour du compteur de 350 à 431
- [x] 30. Organisation > Sociétés françaises : renommé en « Autres sociétés françaises » / « Other French Societies » — titre de page (FR/EN), description (FR/EN) et entrées de menu dans hugo.yaml mis à jour, car cette rubrique présente les sociétés sœurs et non SAR France elle-même
- [x] 31. Activités > _index.md : restructuration complète de la page d'accueil de la section Activités (FR/EN) — ajout de liens vers les sous-pages (agenda, dictionnaire, prix Trentinian, publications, bibliothèque), développement du contenu avec introduction, sous-sections détaillées et section « Pour en savoir plus » / « Learn More » sur le même schéma que les sections Histoire et Organisation. Séparation de « Conférences et manifestations commémoratives » en deux rubriques distinctes : « Conférences et visites » et « Manifestations commémoratives »
